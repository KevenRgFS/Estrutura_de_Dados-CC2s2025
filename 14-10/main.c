...
int main()
{
    //Tarefa T = {"Preparar relatório da disciplina RT", "Ana Maria", EM_ANDAMENTO, 0.75, 5};
    ...
    {
        printf("%d\t", i );
        printf("%s\t", Planner->Dados[i].Titulo);
    }

    GerarHTMLTabela(Planner, "TabelaTarefas.html");
